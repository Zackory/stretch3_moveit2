...
def generate_launch_description():
    ...
    with open(moveit_config_path / 'config/stretch3_description_dex.srdf', 'r') as f:
    ...
    move_group_launch_py = PythonLaunchDescriptionSource(str(moveit_config_path / 'launch/move_group_stretch3.launch.py'))
    ...
    movegroup_test_py = PythonLaunchDescriptionSource(str(moveit_config_path / 'launch/movegroup_test_stretch3.launch.py'))
